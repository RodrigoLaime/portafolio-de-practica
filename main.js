...
try{
    ...
    console.log("en el bloque de finally se ejecutara siempre al final de un bloque try-catch");
}
...
const numer = [1,2,3,4];
//sin destructraccion
let uno = numer[0], dos = numer[1], tres = numer[2]; 
...
const perro = {nom: nom, edad: edad, ladrar: function(){
...
console.log(lolaBunny);
    ...
    const snoopy2 = new Animal2("Snoopy", "Macho"), lolaBunny2 = new Animal2("Lola Bunny", "Hembra");
